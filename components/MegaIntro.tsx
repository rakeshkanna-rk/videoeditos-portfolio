        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150vw] h-[150vw] border border-sky-500/5 rounded-full"
            />
          </div>
              ...
              >
                ...
                <div className="grid gap-3 sm:gap-4">
                  {VE_PROCESS.map((item) => (
                    ...
                    >
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-sky-500/10 flex items-center justify-center text-sky-400 shrink-0 font-mono text-[10px] font-bold">
                        {item.id}
                      </div>
                      <div>
